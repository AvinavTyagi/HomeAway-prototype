...
class UserDashboard extends Component {
    ...
    componentDidMount() {
        ...
        axios.post('http://localhost:3001/loadUserBookings', data)
            .then(response => {
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12 pop_box_div" id="resultSection">
                        <article class="search-result row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 excerpet">
                                ...
                                <li><span><i class="glyphicon glyphicon-bed"></i>Belongs to: {result.owner}</span></li>
                                <li><span><i class="glyphicon glyphicon-flash"></i>Booked From: {result.fromDate}</span></li>
                                <li><span><i class="glyphicon glyphicon-flash"></i>Booked till: {result.toDate}</span></li>
                                </ul>
                            </div>
